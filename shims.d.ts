...
declare namespace pixy2 {
    ...
    function changeProg(prog: string): Resolution;
    ...
    //% parts="pixy2" shim=pixy2::cccGetBlocks
    function cccGetBlocks(wait: boolean, sigmap: uint8, maxBlocks: uint8): Block;
    ...
    //% parts="pixy2" features.defl=0x07 wait.defl=1 shim=pixy2::lineGetMainFeatures
    function lineGetMainFeatures(features?: uint8, wait?: boolean): Features;
    ...
    //% parts="pixy2" features.defl=0x07 wait.defl=1 shim=pixy2::lineGetAllFeatures
    function lineGetAllFeatures(features?: uint8, wait?: boolean): Features;
    ...
    function videoGetRGB(x: uint16, y: uint16, saturate?: boolean): RGB;
}
